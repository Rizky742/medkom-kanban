 ...
 *
 * GANTI PIN BAWAAN INI sebelum disebar ke tim.
 * Catatan jujur: ini kunci sederhana level prototype (cek di
 * browser), bukan login bank. Cukup untuk menahan pengunjung
 * iseng + membedakan hak Admin vs Anggota.
 * Login Google beneran bisa dipasang nanti (butuh setup
 * OAuth di akun genbiunair26@gmail.com).
 * ============================================================ */
export const ADMIN_PIN = "654321";
export const MEMBER_PIN = "123456";
